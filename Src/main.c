...
int main(void)
{
  ...
  osThreadDef(Task, vTask_function, osPriorityNormal, 2, 100);
  Task_function_handle[0] = osThreadCreate(osThread(Task), (void *) pcText_task1);
  Task_function_handle[1] = osThreadCreate(osThread(Task), (void *) pcText_task2);
...
void StartDefaultTask(void const * argument)
{
  ...
  osThreadTerminate(defaultTaskHandle); /* Not supposed to reach here */
  /* USER CODE END 5 */ 
}
